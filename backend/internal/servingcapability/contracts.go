...
func DefaultContracts() []ServingCapabilityContract {
	contracts := []ServingCapabilityContract{
		...
		releasedContract(registrydefault.ProtocolOpenAICodex, credentialstore.VendorOpenAI,
			[]string{credentialstore.AuthModeChatGPTOAuth, credentialstore.AuthModeCodexCLIOAuth, credentialstore.AuthModeCodexAgentIdentity, credentialstore.AuthModeCodexWebOAuth},
			[]string{credentialstore.RuntimeSessionToken, credentialstore.RuntimeCodexAgentIdentity, credentialstore.RuntimeUpstreamPassthrough},
