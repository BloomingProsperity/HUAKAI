...
func (d AuditVerifyStaticDeps) AuditLedger() Ledger { return d.Ledger }
...
func auditVerifyRequestFromHTTP(w http.ResponseWriter, r *http.Request) (AuditVerifyRequest, bool) {
	...
	case http.MethodPost:
		if r.ContentLength > BodyMaxBytes {
...
func auditLedgerFromDeps(d AuditVerifyDeps) (Ledger, bool) {
	if d == nil {
		return nil, false
	}
...
func ResponseForEntry(entry auditledger.LedgerEntry) AuditVerifyResponse {
	return auditVerifyResponse(entry)
}
