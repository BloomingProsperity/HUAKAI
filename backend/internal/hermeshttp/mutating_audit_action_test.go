...
// alert_rule_enable/disable 映射到迁移 0160 准入的 hermes.tool.alert_rule_*、moderation_keyword_enable/
// disable 映射到迁移 0161 准入的 hermes.tool.moderation_keyword_*。
...
func TestMutatingAuditActionMapsEveryMutatingTool(t *testing.T) {
	cases := map[string]string{
		...
		hermesops.ToolModerationKeywordEnable:  "hermes.tool.moderation_keyword_enable",
		hermesops.ToolModerationKeywordDisable: "hermes.tool.moderation_keyword_disable",
	}
