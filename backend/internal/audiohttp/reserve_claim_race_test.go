...
// TestAudioSpeechHandler_ReserveClaimRaceReturns409RetryAfter 守 reserve 阶段的
...
func TestAudioSpeechHandler_ReserveClaimRaceReturns409RetryAfter(t *testing.T) {
	...
	rec := env.invokeJSON(t, `{"model":"tts-1","input":"hello world","voice":"alloy"}`)
