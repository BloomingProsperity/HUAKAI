...
func TestPASRCacheFeedback_E2E_RegisterAndObserve(t *testing.T) {
	...
	// 模拟 proto adapter 在 message_stop 调 (M5b: tenantID=1 必填)
	cachemetrics.ObserveByAccountWithPrefix(2048, 0, 1, chosenAcc, prefix)
	...
	cachemetrics.ObserveByAccountWithPrefix(0, 1024, 1, chosenAcc, prefix)
