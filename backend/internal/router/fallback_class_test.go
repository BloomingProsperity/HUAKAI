...
func TestATBFC003NormalOnlyLegacyProjectionIsByteStable(t *testing.T) {
	...
	want := []byte(`{"Attempts":[{"Index":0,"PoolGroupID":301,"BindingID":3001,"MaxParallelRequests":7,"RequiredCapabilities":["stream","tools"],"MaxConcurrencyHint":0,"Reason":"primary","UpstreamModelID":"model-a"},{"Index":1,"PoolGroupID":302,"BindingID":3002,"MaxParallelRequests":11,"RequiredCapabilities":["stream","tools"],"MaxConcurrencyHint":0,"Reason":"cross_pool_fallback","UpstreamModelID":"model-b"},{"Index":2,"PoolGroupID":301,"BindingID":3001,"MaxParallelRequests":7,"RequiredCapabilities":["stream","tools"],"MaxConcurrencyHint":0,"Reason":"same_pool_account_failover","UpstreamModelID":"model-a"}],"AttemptBudget":3,"RetryableEndClasses":["upstream_error_5xx","upstream_rate_limit","first_token_timeout","inter_event_timeout"],"SnapshotVersion":"registry:7:33;router:v0.2-binding-weighted"}`)
