-- 0159: 准入两个新只读诊断工具 provider_catalog_list / channel_catalog_list 的工具名。
--
-- 两者均为 READ-ONLY 工具(列出本租户供应商/渠道目录):被调用时只经 internal_tool_handler.recordCall
...
-- admin_audit_events.action 有意不动。同 0152-0158。
--
-- CHECK 不可组合,故 DROP+ADD 并**逐字复现** 0158 的 17 个工具名 + 新增 provider_catalog_list、
