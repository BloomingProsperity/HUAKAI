-- 0156: 准入新只读诊断工具 quota_policy_list 的工具名。
--
-- quota_policy_list 是 READ-ONLY 工具(列出本租户配额策略):被调用时只经 internal_tool_handler.recordCall
...
-- admin_audit_events.action 有意不动。同 0152-0155。
--
-- CHECK 不可组合,故 DROP+ADD 并**逐字复现** 0155 的 14 个工具名 + 仅新增 quota_policy_list。
