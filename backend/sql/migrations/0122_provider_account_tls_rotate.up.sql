...
COMMENT ON COLUMN provider_accounts.tls_fingerprint_rotate IS
    'HUAKAI UTLS-04: true=在 tenant active TLS profile 池里按 account 确定性轮换 (anti-JA3-clustering, 同账号粘定); 默认 false 维持单 FK 绑定/builtin.';
COMMIT;
