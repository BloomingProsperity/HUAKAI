-- 0107_admin_audit_unlock_user_action.down.sql
--
-- Conservative rollback: if unlock_user audit rows already exist,
-- PostgreSQL rejects the restored CHECK constraint.
