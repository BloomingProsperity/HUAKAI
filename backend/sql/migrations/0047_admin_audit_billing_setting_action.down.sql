-- 0047_admin_audit_billing_setting_action.down.sql
--
-- 回滚 Case C 计费设置审计 action/target_type 白名单扩展。
-- 若已存在 billing_setting 审计行，PostgreSQL 会拒绝回滚；
-- 这是与既有 CHECK 回滚保持一致的保守行为。
