-- 0158: 准入新只读诊断工具 alert_event_list 的工具名。
--
-- alert_event_list 是 READ-ONLY 工具(列出本租户告警事件):被调用时只经 internal_tool_handler.recordCall
...
-- admin_audit_events.action 有意不动。同 0152-0157。
--
-- CHECK 不可组合,故 DROP+ADD 并**逐字复现** 0157 的 16 个工具名 + 仅新增 alert_event_list。
