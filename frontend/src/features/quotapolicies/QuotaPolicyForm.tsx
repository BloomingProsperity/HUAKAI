...
function Banner({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ margin: 'var(--hk-space-4)', marginBottom: 0, padding: 'var(--hk-space-3)', borderRadius: 'var(--hk-radius-md)', fontSize: 13, color: '#8f322a', background: '#fbe9e7', border: '1px solid #f2cdc8' }}>
      {children}
    </div>
  )
}
...
const enforceHint: React.CSSProperties = { margin: '0 var(--hk-space-4) var(--hk-space-4)', padding: 'var(--hk-space-3)', borderRadius: 'var(--hk-radius-md)', fontSize: 12, color: '#8a5e0f', background: '#fbf3df', border: '1px solid #f0e2bd' }
