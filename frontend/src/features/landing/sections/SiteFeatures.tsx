// HUAKAI 落地页 — 能力特性网格(6 张卡片)。
import { useState } from 'react';
import { Badge, Icon } from '../landingKit';

// 配色 tone:每个 key 对应一组前景/背景/边框 CSS 值。
type ToneSpec = { fg: string; bg: string; bd: string };
type ToneName = 'teal' | 'emerald' | 'amber' | 'blue' | 'violet' | 'slate';

const HK_TONES: Record<ToneName, ToneSpec> = {
...
// 卡片底部脚注:要么是等宽字体的代码文本,要么是一个徽章。
type FeatureFoot =
  | { type: "code"; text: string }
  | { type: "badge"; variant: 'default' | 'outline'; text: string };
