...
const dangerBtn: React.CSSProperties = { height: 32, padding: '0 var(--hk-space-3)', border: '1px solid #f2cdc8', borderRadius: 'var(--hk-radius-md)', background: '#fbe9e7', color: '#8f322a', fontSize: 13, fontWeight: 600, cursor: 'pointer' }
