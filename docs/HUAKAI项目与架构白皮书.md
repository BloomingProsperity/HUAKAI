...
> 文档状态：现行主线总纲
> 事实基线：`origin/main@b97edcd3cb29634b66c76251297a38e02583b007`
> 核实日期：2026-09-11
...
| 资产 | 本提交实数 | 统计口径 |
| --- | ---: | --- |
| Go 包 | 346 | `backend` 模块内 `go list ./...` |
| Go 生产文件 | 1406 | 与 `docs/源码责任索引.md` 当前统计一致；排除 `_test.go` |
...
白皮书负责稳定产品能力、架构边界和承重构件，不把 1406 个 Go 生产文件逐个复制进正文。
