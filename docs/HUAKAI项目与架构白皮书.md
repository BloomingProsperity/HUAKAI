...
> 文档状态：现行主线总纲
> 事实基线：`origin/main@c5443f0e5afa37603687a29cd79003e90d532d71`
> 核实日期：2026-09-13
...
| Go 生产文件 | 1440 | 与 `docs/源码责任索引.md` 当前统计一致；排除 `_test.go` |
...
白皮书负责稳定产品能力、架构边界和承重构件，不把 1440 个 Go 生产文件逐个复制进正文。
