...
| Counterpart | `docs/plans/2026-04-30-n5-model-registry-codex.md` (drafted in parallel; not read while authoring this) |
...
Source files read: backend/internal/router/route_plan.go, backend/internal/router/default_router.go, backend/internal/gatewayhttp/chat_completions_handler.go, backend/sql/migrations/0001_pool_routing.up.sql, backend/sql/migrations/0007_l0_inbound_auth.up.sql, docs/specs/_invariants/cross-module-boundaries.md, docs/plans/2026-04-30-n4-l0-minimum.md.
Lane: specifier
