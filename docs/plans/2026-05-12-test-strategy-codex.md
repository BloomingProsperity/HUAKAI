...
| P0 | 对 INV-19/28/38/44/47/48/49/50 写明确 disposition：Implemented、Audit-only、Deferred、Reserved，不允许“消失” | 0.5 ed | `docs/plans/2026-05-12-p1-capability-payload-refinement-synthesis.md` | 编号漂移会让矩阵无法交叉审查 |
