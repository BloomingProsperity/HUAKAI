...
| Existing plan basis | `docs/plans/2026-05-15-r-c-lane-2-architecture-codex.md` 记录 D1=(c) native OpenSSL + HUAKAI adapter + MIT `http2` fork，D2=窄 patch 允许，D3=KnownGapBlocked 严格派 |
...
- Lane 2 D1/D2/D3 architecture plan and L2 atom sequence: `docs/plans/2026-05-15-r-c-lane-2-architecture-codex.md`.
