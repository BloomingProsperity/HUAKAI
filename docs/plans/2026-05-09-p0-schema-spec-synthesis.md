...
**日期**: 2026-05-09
**前置 lanes**:
- `docs/plans/2026-05-09-p0-schema-spec-claude.md`（Sonnet 1377 行 / 76 KB）
- `docs/plans/2026-05-09-p0-schema-spec-codex.md`（Codex 67 KB / ~1300 行）
...
Source files read: `docs/plans/2026-05-09-p0-schema-spec-{claude,codex}.md` (HUAKAI internal — exempt per #12)；`backend/internal/proto/hcsf.go` / `proto.go` / `openai_sse.go` / `gemini_sse.go` (HUAKAI internal — exempt)
