...
427. D13 范围：docs/reviews/PENDING 或 release notes 记录 test gaps。
...
625. Claude 也应独立写 `docs/plans/2026-05-12-p2-client-adapter-plan-claude.md`。
626. 两份 plan 完成后由 PM 做 synthesis。
627. synthesis 文件建议名：`docs/plans/2026-05-12-p2-client-adapter-plan.md`。
