...
| P1 #4 | docs/plans/2026-05-17-f-comm-001-invitation-referral-spec-claude.md:108-112 | HIGH | Claude plan §7 uncited Sub2API claims, 违 CLAUDE.md #12 first-cite 必读 source 规则 |
...
Edit docs/plans/2026-05-17-f-comm-001-invitation-referral-spec-claude.md §7 表格:
...
(已 Edit, 见 docs/plans/2026-05-17-f-comm-001-invitation-referral-spec-claude.md 当前版本.)
