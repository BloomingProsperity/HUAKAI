...
| Counterpart | `docs/plans/2026-04-30-n5-model-registry-codex-v2.md` (drafted in parallel; not read while authoring this) |
...
Source files read:
  HUAKAI repo: docs/plans/2026-04-30-n5-model-registry-claude.md, docs/plans/2026-04-30-n5-model-registry-codex.md, docs/07_REFERENCE_EVIDENCE_LEDGER.md (lines 1-130), docs/06_REFERENCE_PROJECTS.md, docs/05_CLEAN_ROOM_POLICY.md, docs/specs/_invariants/cross-module-boundaries.md, docs/02_HUAKAI_FUSION_ARCHITECTURE.md, backend/internal/router/route_plan.go, backend/internal/router/default_router.go, backend/internal/gatewayhttp/chat_completions_handler.go, backend/sql/migrations/0001_pool_routing.up.sql.
