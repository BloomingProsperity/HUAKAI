...
| 输出文件 | `docs/process/plans/2026-05-12-p1-capability-payload-refinement-codex.md` |
| 独立性 | 未读取 Claude lane 文件 `docs/process/plans/2026-05-12-p1-capability-payload-refinement-claude.md`。 |
...
- 不修改代码。
- 不修改 fixture。
- 预期新增文档：可选 `docs/process/plans/2026-05-12-p1-fixture-impact.md`。
