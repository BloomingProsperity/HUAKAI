...
**对应 Claude 草案**: `docs/process/plans/2026-05-09-three-directions-claude.md`（写作时未打开、未读取）  
**触发**: Owner 提出三方向  
...
4. **Provider breadth + protocol/cost correctness**  
   Project brief 和 DR-007 都把 provider/model breadth 作为 HUAKAI 超越 Sub2API 的主差异化。证据：`docs/01_PROJECT_BRIEF.md:18`, `docs/01_PROJECT_BRIEF.md:40-44`; `docs/process/decisions/DR-007-product-positioning-and-breadth.md:34-35`。  
