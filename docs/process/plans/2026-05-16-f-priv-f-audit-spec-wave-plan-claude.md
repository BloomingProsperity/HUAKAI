...
3. **Claude 2 spec parallel-draft** (在 codex lane 跑期间):
   - F-PRIV-001 Claude draft → `docs/process/plans/2026-05-16-f-priv-001-spec-claude.md`
   - F-AUDIT-001 Claude draft → `docs/process/plans/2026-05-16-f-audit-001-spec-claude.md`
