...
Read: `docs/process/plans/2026-05-14-r3-on-merged-closure-codex.md` (§4 Phase R-E),`docs/10_RISK_REGISTER.md` (R-SEC-002 / R-TRANSPORT-001),`exploratory/rust-core-gateway/merged/crates/core_gateway/src/mimicry/` (现有结构),`docs/process/plans/2026-05-15-r-3-r-d-claude.md` (本人 R-D 平行计划)。
