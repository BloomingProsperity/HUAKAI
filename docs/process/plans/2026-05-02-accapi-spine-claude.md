...
Companion (must be written independently): `docs/process/plans/2026-05-02-accapi-spine-codex.md` — to be drafted by Codex without seeing this file.
...
- Doc updates: `docs/03_FEATURE_PARITY_MATRIX.md` (9 rows), `docs/02_HUAKAI_FUSION_ARCHITECTURE.md` (spine section), `docs/process/decisions/DR-NNN-account-to-api-mainline.md` new DR
...
| `docs/process/decisions/DR-NNN-account-to-api-mainline.md` | new DR (NNN to be assigned) |
...
- [ ] Codex reads `docs/process/plans/2026-05-02-accapi-spine-codex.md` is written without seeing this file (CLAUDE.md #10)
