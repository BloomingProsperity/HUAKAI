...
Inputs:
- `docs/process/plans/2026-05-02-accapi-spine-claude.md` (commit `ced523f`, 396 lines)
- `docs/process/plans/2026-05-02-accapi-spine-codex.md` (commit `1b939df`, 670 lines)
