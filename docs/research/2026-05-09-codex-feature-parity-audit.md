...
| LiteLLM | prefix-hash cache locality pin | HCSF/PASR next pivot explicitly repairs OpenAI/Gemini cache signal ingestion (`docs/process/plans/2026-05-09-next-pivot-synthesis.md:20-29`). | Feature matrix should add LiteLLM/new-api evidence to PASR rows, but user outcome is covered by PASR delta (`docs/process/plans/2026-05-09-three-directions-synthesis.md:94-104`). | MED: evidence/disposition sync needed |
| LiteLLM | MidStreamFallbackError continuation + usage merge | HCSF marks mid-stream fallback as P-8 (`docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:94`, `docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:119`). | Next-pivot suggests D-0 spec skeleton after PASR repair (`docs/process/plans/2026-05-09-next-pivot-synthesis.md:56`). | Mandatory Roadmap P-8 |
| LiteLLM | 100+ provider normalization | HCSF 14 capability + native passthrough + Tier A/B provider split covers first slice (`docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:38-64`, `docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:66-80`). | Provider catalog breadth is Phase 9 exit criterion (`docs/16_PHASED_DELIVERY_PLAN.md:265-290`). | Implemented Better target |
...
| Portkey | bi-canonical OpenAI + Anthropic | HCSF explicitly chooses OpenAI storefront + Anthropic native side-entry + capability graph (`docs/process/plans/2026-05-09-hcsf-canonical-synthesis.md:66-123`). | P-2/P-4 phases implement adapters/native passthrough (`docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:27-34`). | Implemented Better target |
...
| Portkey | TransformStream + streamState | HCSF stream plan and F-GW-002 cover stream states and terminal classification (`docs/process/plans/2026-05-09-p0-schema-spec-synthesis.md:145-153`; `docs/03_FEATURE_PARITY_MATRIX.md:38`). | Implemented Better target. | Pass |
...
| Envoy AI Gateway | TokenProvider / preRotation / OIDC->cloud STS | Source-read lane says these should become TokenProvider + enterprise roadmap (`docs/research/2026-05-09-source-read-helicone-envoy-allapihub.md:206-225`). | Three-directions says "mark Mandatory Roadmap" but no `F-*` row or phase ID exists (`docs/process/plans/2026-05-09-three-directions-synthesis.md:121-124`). | **HIGH MISSING_DISPOSITION** |
...
| Envoy AI Gateway | per-endpoint canonical | HCSF aligns: OpenAI chat + Anthropic messages + capability graph, and cites per-endpoint canonical as a delta (`docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:115-121`). | Implemented Better target. | Pass |
...
| OpenAI server-side compaction / `/responses/compact` | Issue mining names Codex remote compaction as a user demand (`docs/research/2026-05-09-issue-mining-cross-repo.md:82`, `docs/research/2026-05-09-issue-mining-cross-repo.md:199`). HCSF native passthrough lists `/v1/native/openai/responses`, but no compact route/capability/disposition is named (`docs/process/plans/2026-05-09-hcsf-canonical-synthesis.md:115-122`). | **HIGH MISSING_DISPOSITION** unless Owner declares it covered by `/v1/native/openai/responses/*`. |
| Gemini `inline_data` | Gemini current-state audit says inlineData is lossy today (`docs/research/2026-05-09-axis3-huakai-current-state.md:90`, `docs/research/2026-05-09-axis3-huakai-current-state.md:132`). HCSF has separate `file` / `image` / `audio` / `video` nodes (`docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:50-53`). | LOW: MIME-based split is enough; document `image/* -> image`, other binary -> file/audio/video. |
| xAI server-side tools / Remote MCP | HCSF has `mcp_server` capability (`docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:56`). Official OpenAI MCP docs also model remote MCP as a tool entry used with hosted tools. | Pass: map to `mcp_server`; native passthrough for xAI-specific server-side tool dialects. |
...
- Native passthrough should be shown in admin UI as "full vendor risk", matching HCSF D5 guidance (`docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:142-145`).
- `ValidateEnvelope` comment still says INV-1..12 while P-0c plans INV-13 (`backend/internal/proto/envelope_validate.go:20-33`; `docs/process/plans/2026-05-09-p0c-followup-plan-synthesis.md:21-28`).
...
- `docs/process/plans/2026-05-09-hcsf-canonical-synthesis.md:66-123`
- `docs/process/plans/2026-05-09-hcsf-v04-implementation-synthesis.md:23-64`, `:91-122`, `:123-176`
- `docs/process/plans/2026-05-09-p0-schema-spec-synthesis.md:19-34`, `:154-187`, `:189-239`
- `docs/process/plans/2026-05-09-p0c-followup-plan-synthesis.md:9-18`, `:19-60`, `:71-119`
- `docs/process/plans/2026-05-09-three-directions-synthesis.md:44-104`, `:106-143`, `:160-201`
- `docs/process/plans/2026-05-09-next-pivot-synthesis.md:18-29`, `:47-67`, `:88-115`
