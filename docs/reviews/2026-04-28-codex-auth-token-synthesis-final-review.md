...
- Evidence: `docs/decisions/DR-000-clean-room-methodology.md:77` approves Option C carve-outs for `billing ledger, account-pool routing, and provider failover/account-health heuristics`.
...
1. Lane mode is unsupported by DR-000's Option C carve-out.
   ...
   - Evidence: `docs/decisions/DR-000-clean-room-methodology.md:77` limits Option C carve-outs to `billing ledger, account-pool routing, and provider failover/account-health heuristics`.
   - Confidence: HIGH.
